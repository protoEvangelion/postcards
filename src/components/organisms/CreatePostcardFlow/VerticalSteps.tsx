        ...
        const colors = React.useMemo(() => {
            ...
            switch (color) {
                case 'primary':
                    ...
                    fgColor =
                        '[--step-fg-color:hsl(var(--nextui-primary-foreground))]'
                    break
                case 'secondary':
                ...
                case 'success':
                    ...
                    fgColor =
                        '[--step-fg-color:hsl(var(--nextui-success-foreground))]'
                    break
                case 'warning':
                    userColor = '[--step-color:hsl(var(--nextui-warning))]'
                    fgColor =
                        '[--step-fg-color:hsl(var(--nextui-warning-foreground))]'
                    break
                case 'danger':
                    userColor = '[--step-color:hsl(var(--nextui-error))]'
                    fgColor =
                        '[--step-fg-color:hsl(var(--nextui-error-foreground))]'
                    break
                case 'default':
                    userColor = '[--step-color:hsl(var(--nextui-default))]'
                    fgColor =
                        '[--step-fg-color:hsl(var(--nextui-default-foreground))]'
                    break
                default:
                    userColor = '[--step-color:hsl(var(--nextui-primary))]'
                    fgColor =
                            ...
                            <li key={stepIdx} className="relative">
                                <div className="flex w-full max-w-full items-center">
                                    <button
                                        ...
                                        className={cn(
                                            'group flex w-full items-center justify-center gap-4 rounded-large px-3 py-2.5',
                                            stepClassName
                                        )}
