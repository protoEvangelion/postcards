                    ...
                    <div>
                        <div className="text-center">
                            ...
                            <p className="mt-2 text-lg">
                                ...
                                needs. No hidden fees, just transparent options
                                for your success.
                            </p>
                        </div>
                                    ...
                                    <Card className="bg-base-200 text-base-content">
                                        <Card.Body className="p-6 gap-0">
                                            ...
                                            <p className="mt-4 text-sm">
                                                Experience essential features at
                                                no cost, setting the foundation
                                    ...
                                    <Card className="bg-base-200">
                                        <Card.Body className="p-6  gap-0">
                                            ...
                                            <p className="mt-6 text-sm">
                                                ...
                                                our ultimate plan. Maximize
                                                features, scalability, and
                                                success.
                                            </p>
                                        </Card.Body>
                                    </Card>
