                ...
                <div>
                    ...
                    <div className="relative z-[2] mt-8 grid gap-8 lg:mt-20 lg:grid-cols-2 lg:gap-12">
                        ...
                        <div className="lg:mt-8">
                            ...
                            <p className="mt-2 text-base font-medium">
                                ...
                                dashboard—real-time insights, intuitive
                    ...
                    <div className="mt-8 grid gap-8 lg:mt-20 lg:grid-cols-2 lg:gap-12">
                        <div>
                            ...
                            <p className="mt-2 text-base">
                                ...
                                projects, and resources in one centralized hub.
                                Gain real-time insights, streamline workflows,
                    ...
                    <div className="mt-8 grid gap-8 lg:mt-20 lg:grid-cols-2 lg:gap-12">
                        ...
                        <div className="lg:mt-7">
                            ...
                            <p className="mt-2 text-base">
                                Connect key tools seamlessly with our SaaS
                                platform, streamlining your processes and
                                boosting productivity. Experience a cohesive
                                digital ecosystem that empowers your business
