                ...
                <div>
                    <div className="text-center">
                        ...
                        <p className="mt-2 text-lg sm:text-center">
                            Effortless Collaboration: Seamlessly integrate tools
                            for unified efficiency with our SaaS platform.
                        </p>
                    </div>
                        ...
                        <div className="grid items-center gap-8 lg:grid-cols-2">
                            <div className="inline-flex flex-col text-center lg:text-start">
                                <h3 className="text-3xl font-medium leading-snug">
                                    Effortless expert Saas integrations, just a
                                    snap away.
                                </h3>
                                <p className="mt-4 text-lg leading-normal">
                                    ...
                                    effortlessly for a unified digital
                                    workspace.
                                </p>
                    ...
                    <div className="mt-6 grid gap-6 lg:grid-cols-3">
                        <Card className="cursor-pointer transition-all hover:shadow">
                            <Card.Body className="p-6 gap-0">
                                ...
                                <p className="mt-4 text-sm">
                                    Streamline project discussions, share
                                    updates, and boost real-time collaboration
                                    effortlessly.
                                </p>
                            </Card.Body>
                        </Card>
                        ...
                        <Card className="cursor-pointer transition-all hover:shadow">
                            <Card.Body className="p-6 gap-0">
                                ...
                                <p className="mt-4 text-sm">
                                    ...
                                    Elevate your productivity with the
                        ...
                        <Card className="cursor-pointer transition-all hover:shadow">
                            <Card.Body className="p-6 gap-0">
                                ...
                                <p className="mt-4 text-sm">
                                    Streamline version control, collaboration,
                                    and project management with ease. Embrace
