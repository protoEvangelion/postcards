            ...
            <div>
                <div className="flex flex-col items-center">
                    ...
                    <p className="mt-4 text-lg sm:text-center">
                        Unlock the Full Potential of Your Business with Our SaaS
                ...
                <div className="relative z-[2] mt-8 grid gap-8 lg:mt-20 lg:grid-cols-2 lg:gap-12">
                    ...
                    <div className="lg:mt-8">
                        ...
                        <p className="mt-2 text-base font-medium">
                            Elevate control with our dynamic SaaS
                            dashboard—real-time insights, intuitive navigation,
                ...
                <div className="mt-8 grid gap-8 lg:mt-20 lg:grid-cols-2 lg:gap-12">
                    <div>
                        ...
                        <p className="mt-2 text-base">
                            Our SaaS platform offers seamless management,
                            allowing you to effortlessly oversee users,
                            projects, and resources in one centralized hub. Gain
                            real-time insights, streamline workflows, and
                            optimize resource allocation for unparalleled
                            efficiency.
                        </p>
                ...
                <div className="mt-8 grid gap-8 lg:mt-20 lg:grid-cols-2 lg:gap-12">
                    ...
                    <div className="lg:mt-7">
                        ...
                        <p className="mt-2 text-base">
                            Connect key tools seamlessly with our SaaS platform,
                            streamlining your processes and boosting
                            productivity. Experience a cohesive digital
                            ecosystem that empowers your business for innovation
                            and growth.
                        </p>
